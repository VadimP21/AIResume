...
При добавлении или изменении функциональности проверять и обновлять затронутую
документацию.
...
- документацию при добавлении или изменении функциональности, API, конфигурации или процесса работы;
